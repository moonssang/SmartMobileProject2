            ...
            public void onSessionOpened() {
                ...
                UserManagement.getInstance().me(new MeV2ResponseCallback() {
                    ...
                    public void onSuccess(MeV2Response result) {
                        ...
                        jsonParsing.execute("https://phpproject-cparr.run.goorm.io/kakaologin.php?email="+email+"&name="+name);
                        //gethttpresponse.execute("https://phpproject-cparr.run.goorm.io/kakaologin.php?email="+email+"&name="+name);
