...
public class UploadImage {
    ...
    public UploadImage(Context context){
        ...
        Log.d("hello", String.valueOf(context));
    ...
    public boolean Upload(String imgPath,String longtitude,String latitude,String email){
        ...
        smpr.addStringParam("latitude", latitude);
        smpr.addStringParam("longtitude", longtitude);
